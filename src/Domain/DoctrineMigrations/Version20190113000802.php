 ...
 */
final class Version20190113000802 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE amo_brand (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', name VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE amo_phone (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', amo_brand_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', amo_phone_os_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', amo_phone_memory_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', amo_type_connector_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_E4B4D2CDFFB2E30C (amo_brand_id), INDEX IDX_E4B4D2CDD54A68AF (amo_phone_os_id), INDEX IDX_E4B4D2CD93B71B59 (amo_phone_memory_id), INDEX IDX_E4B4D2CD6D444093 (amo_type_connector_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE amo_phone_memory (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', name VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE amo_type_connector (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', name VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
